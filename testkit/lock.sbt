...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-http-core_2.12" % "10.0.0",
  "com.typesafe.akka" % "akka-http-testkit_2.12" % "10.0.0",
  "com.typesafe.akka" % "akka-http_2.12" % "10.0.0",
  "com.typesafe.akka" % "akka-parsing_2.12" % "10.0.0",
  ...
  "com.typesafe.akka" % "akka-stream-testkit_2.12" % "2.4.14",
...
// LIBRARY_DEPENDENCIES_HASH e9faf7b4018b500c84f95a278dada54fdeac6c85
